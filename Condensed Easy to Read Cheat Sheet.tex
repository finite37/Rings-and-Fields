...
\renewenvironment{proof}[1][\proofname]{%
  \begin{tcolorbox}[proofpairboxstyle]%
  \pushQED{\qed}%
...
\fontsize{5.45}{6.55}\selectfont
    ...
    \raggedright
        ...
        Given a completed algorithm we can obtain \(n,m\in\mathbb{Z}\) s.t. \(na+mb=\gcd(a,b)\) i.e. taking the start of a Euclidian algorithm:
        ...
        {\centering\scriptsize \(r_n=\gcd(a,b)=na+mb,\quad n,m\in\mathbb{Z}.\)\par}
        \vspace{2pt}
